...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 2024.07 ~ 2026.02    | **Crop for Trust: 생성형AI 기반 신뢰성 강화 및 편향 제거 프레임워크** 🔒 *Private Repository*    |   생성형 AI(Gemini 2.5 Flash)와 YOLO 모델을 이용한 편향 제거 프레임워크 개발 및 다양한 방법론 검증    | 연구생 (개인)    | Python, Pytorch, Docker, Hugging Face, Roboflow, Gemini API    | • **ESWA (IF: 7.5) 저널 투고** (Under Review)<br>• **2024 KSC 논문 게재**<br>• 교내외 AI 공모전 2회 수상 |   
